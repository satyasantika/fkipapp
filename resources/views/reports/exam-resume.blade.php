                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $list->kode_laporan }}" aria-expanded="false" aria-controls="collapse{{ $list->kode_laporan }}">
                                ...
                                @endphp
                                Bulan {{ Carbon\Carbon::createFromFormat('Y-m',$list->kode_laporan)->isoFormat('MMMM Y') }} - Total Ujian:&nbsp; <span class="badge bg-primary">{{ $penguji->count() }}</span>&nbsp; - Total Penguji:&nbsp; <span class="badge bg-dark">{{ $collection->unique()->values()->count() }}</span>
                            </button>
                            </h2>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        @forelse (App\Models\ViewExamRegistration::where('kode_laporan',$list->kode_laporan)
                                                    ...
                                                    ->select('tanggal_ujian')->distinct()->get()->sort(); as $list)
                                            <tr>
